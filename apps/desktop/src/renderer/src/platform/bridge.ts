...
function createPreviewBridge(): DesktopBridge {
  ...
  return {
    ...
    planWorkflow: async () => desktopRequired(),
    navigate: async () => desktopRequired(),
    observePage: async () => desktopRequired(),
    highlight: async () => desktopRequired(),
    clearHighlight: async () => desktopRequired(),
    startRecording: async () => desktopRequired(),
    stopRecording: async () => desktopRequired(),
    startPicker: async () => desktopRequired(),
    pickElement: async () => desktopRequired(),
    cancelPick: async () => desktopRequired(),
    controlWindow: async () => undefined,
    startRun: async () => desktopRequired(),
    dryRun: async () => desktopRequired(),
