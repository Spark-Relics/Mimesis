export const zhCN = {
  ...
  pickLabel: "点选",
  pickPicking: "点击页面元素…",
  pickHint: "点击页面中的元素,自动填入此选择器",
  pickActiveHint: "在页面中点击目标元素自动填入;按 Esc 取消",
  flowBefore: "初始化步骤",
...
export const enUS: Record<MessageKey, string> = {
  ...
  pickLabel: "Pick",
  pickPicking: "Click the page…",
  pickHint: "Click an element on the page to fill this selector",
  pickActiveHint: "Click the target element in the page to fill it in; press Esc to cancel",
